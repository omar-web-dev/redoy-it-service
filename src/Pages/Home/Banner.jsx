  ...
  return (
    <div className="pb-4 lg:h-screen bg-[#054ada]">
      <div className="max-w-[1200px] px-3 mx-auto flex flex-col items-center pt-32 md:pt-48 justify-center">
        <h1 className="text-4xl font-bold sm_d_h1 md:header">IT Core Ltd.</h1>
        ...
        <p className="text-center lg:px-60 my-8 text-lg text-gray-50  font-bold md:max-w-[90%] lg:75 pre_text">
