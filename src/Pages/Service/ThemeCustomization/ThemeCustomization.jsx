    ...
    <div>
      ...
      <div className="max-w-[1200px] px-3 mx-auto mt-32">
        ...
        <h4 className="sm_pre_text text-center mb-20">
          ...
          easily handle courses, quizzes, lessons, certificates, and other
          resources. Edema is a totally user-friendly Learning Management
          System.
        </h4>
      </div>
      ...
      <div className="max-w-[1200px] mx-auto mt-20 lg:mt-32 px-3">
        ...
        <p className="sm_pre_text text-center mb-2">
          An expert website design company knows what it takes to create a
          high-customer converting website for your eLearning website. Hiring
          someone with experience in the industry usually results in a better
          website. An unprofessional developer and designer can never give you
          the best website design. They will only waste your time and money.
          They have never been able to build a successful business.
        </p>
        <p className="sm_pre_text text-center mb-2">
          For this reason, it is pointless to expect professional work from an
          unprofessional person, so don’t worry; we are creating educational
          sites by our best designers and developers. We are already building
